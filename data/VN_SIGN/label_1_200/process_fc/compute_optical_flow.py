...
data = pd.read_csv('/mnt/disk3/anhnct/Hand-Sign-Recognition/data/VN_SIGN/label_1_200/full_data_1_200_center_ord1.csv')[5000:]

for idx,row in tqdm(data.iterrows()):
    if not os.path.exists(f'/mnt/disk3/anhnct/Hand-Sign-Recognition/data/VN_SIGN/frames/{row["name"].replace(".mp4","")}'):
