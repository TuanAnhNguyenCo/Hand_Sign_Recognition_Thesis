...
def gen_pose(base_url,file_name,wholebody_detector):
    ...
    kp_folder = video_url.replace("video_200_400",'wholebody_200_400').replace('.mp4',"")
...
if __name__ == "__main__":
    ...
    full_data = pd.read_csv("/mnt/disk2/anhnct/Hand-Sign-Recognition/data/VN_SIGN/label_200_400.csv")
    wholebody_detector = MMPoseInferencer( "td-hm_res152_8xb32-210e_coco-wholebody-384x288")
    print(full_data.shape)

    for idx,data in full_data.iterrows():
        gen_pose("/mnt/disk2/anhnct/Hand-Sign-Recognition/data/VN_SIGN/video_200_400",data['name'],wholebody_detector)
